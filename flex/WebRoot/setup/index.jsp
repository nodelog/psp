...
<%
	...
	if(step == 3){
		...
		if(conf.isWin()){
			String temp = conf.getConfig("cmd.conversion.singledoc", "pdf2swf.exe {path.pdf}{pdffile} -o {path.swf}{pdffile}.swf -f -T 9 -t -s storeallcharacters -s linknameurl  -s languagedir=C:\\xpdf\\xpdf-chinese-simplified");
			ht.set("cmd.conversion.singledoc", temp.replace("pdf2swf.exe", path_to_pdf2swf + "pdf2swf.exe"));
			temp = conf.getConfig("cmd.conversion.splitpages", "pdf2swf.exe {path.pdf}{pdffile} -o {path.swf}{pdffile}_%.swf -f -T 9 -t -s storeallcharacters -s linknameurl  -s languagedir=C:\\xpdf\\xpdf-chinese-simplified");
			...
			String temp = conf.getConfig("cmd.conversion.singledoc", "pdf2swf {path.pdf}{pdffile} -o {path.swf}{pdffile}.swf -f -T 9 -t -s storeallcharacters -s linknameurl  -s languagedir=C:\\xpdf\\xpdf-chinese-simplified");
			ht.set("cmd.conversion.singledoc", temp.replace("pdf2swf", path_to_pdf2swf + "pdf2swf"));
			temp = conf.getConfig("cmd.conversion.splitpages", "pdf2swf {path.pdf}{pdffile} -o {path.swf}{pdffile}_%.swf -f -T 9 -t -s storeallcharacters -s linknameurl  -s languagedir=C:\\xpdf\\xpdf-chinese-simplified");
