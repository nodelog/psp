...
$minezine_themever = "1.0.3";									//Theme version
...
function minezine_scripts_styles() {
    ...
    wp_enqueue_script( 'minezine-placeholders', get_template_directory_uri() . '/js/placeholders.js', array(), '2.1.0', true );
...
add_filter( 'excerpt_length', 'minezine_custom_excerpt_length', 999 );
