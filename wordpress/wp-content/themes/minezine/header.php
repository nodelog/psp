...
<?php if ($minezine_options_db['minezine_header_facebook_link'] != ''){ ?>
          <a class="social-icon facebook-icon" href="<?php echo esc_url($minezine_options_db['minezine_header_facebook_link']); ?>"></a>
<?php } ?>
<?php if ($minezine_options_db['minezine_header_twitter_link'] != ''){ ?>
          <a class="social-icon twitter-icon" href="<?php echo esc_url($minezine_options_db['minezine_header_twitter_link']); ?>"></a>
<?php } ?>
<?php if ($minezine_options_db['minezine_header_google_link'] != ''){ ?>
          <a class="social-icon google-icon" href="<?php echo esc_url($minezine_options_db['minezine_header_google_link']); ?>"></a>
<?php } ?>
<?php if ($minezine_options_db['minezine_header_rss_link'] != ''){ ?>
          <a class="social-icon rss-icon" href="<?php echo esc_url($minezine_options_db['minezine_header_rss_link']); ?>"></a>
<?php } ?>
        </div>
<?php } ?>
      </div>
