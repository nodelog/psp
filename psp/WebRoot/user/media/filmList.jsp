...
<html>
	...
	<body>
					    ...
					    <s:iterator value="#request.filmList"  var="item" status="film"> 
					    	<s:if test='#film.count%5==1'>
			    				<div class="row">
					    	</s:if>
					    	<div class="col-sm-4 col-md-2">
							    <div class="thumbnail single-film filmList">
									    ...
									    <img src="" class="film<s:property value='#film.count'/>">
									      ...
									      $(function(){
									    	if("${item.bgImage.url }"!=""){
										      	...
										      	$('.filmList.thumbnail').find('img.film'+${film.count}).attr("src",_src);
									    	}else{
										      	$('.filmList.thumbnail').find('img.film'+${film.count}).attr("src","images/no-image.png");
									    	}
									      });
									      </script>
									  </div>
