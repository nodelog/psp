	...
	<body>
    	<div id="myProblem">
	    	...
	    	<div class="problemList">
	    	 	<s:if test="#request.myAnswer==null||#request.myAnswer.size()==0"><p>暂无数据</p></s:if>
	    		<s:iterator value="#request.myAnswer" var="item" status="problem">
    		...
    		<div class="my_paging">
    			...
    			getPageTotal();
    			 function getPageTotal(){
    			        $.post("json/problem.loadCountByAnswer.action", function(data){
    			            ...
    			            $('.pagination').jqPagination({
    			                ...
    			                max_page: _count,
    			                paged: function(page){
    			                    location.href="user/problem.loadProblemByAnswer.action?currentPage="+page;
    			                }
    			            });
    			        }, "json");
    			    }
