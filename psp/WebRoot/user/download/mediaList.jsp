	...
	<body>
    	<div class="panel panel-success">
				...
				<table class="table table-hover" >
					...
					<s:else>
					 <thead><tr class="active"><th>序号</th><th>名称</th><th>大小</th><th>上传者</th><th>上传时间</th><th>操作</th></tr></thead>
					</s:else>
					 ...
					 <s:iterator value="#request.downloadList"  var="item" status="media"> 
						...
						<td><a href="${ftpServer }${item.url }" target="_blank" class="btn btn-default download" role="button" data-id="${item.id }" data-type="${categoryId }" data-url="${fileServer }${item.url }"><span class="glyphicon glyphicon-cloud-download"></span>&nbsp;下载</a></td>
						</tr>
					 </s:iterator>
					 </tbody>
			  	</table>
